...
\subsection{CartPole environment} % (fold)
...
% subsection cartpole_environment (end)

\subsection{Acrobot environment} % (fold)
...
\begin{figure}[htb]
    ...
    \label{fig:acrobot}
\end{figure}
% subsection acrobot_environment (end)
...
\subsubsection{CartPole} % (fold)
\label{sub:cartpole}
\paragraph{Without sparse representation transfer} % (fold)
...
% paragraph cartpole:without_sparse_representation_transfer (end)
\paragraph{With sparse representation transfer} % (fold)
...
\end{figure}
% paragraph with_sparse_representation_transfer (end)
...
% paragraph acrobot:without_sparse_representation_transfer (end)
\paragraph{With sparse representation transfer} % (fold)
...
\end{figure}
% paragraph acrobot:with_sparse_representation_transfer (end)
\paragraph{REINFORCE using a source and target task} % (fold)
...
\end{figure}
% paragraph reinforce_using_a_source_and_target_task (end)
