...
\begin{table}[htb]
    ...
    \hline
    \end{tabular}
    \caption{P-values for the Wilcoxon rank-sum test of the jumpstart performances using different algorithms, applied to the \textit{acrobot} environment, where the \textit{TLA} algorithms use sparse representation transfer.}
...
\todo[inline]{Keep or remove this?}
