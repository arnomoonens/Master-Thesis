...
2 other approaches use a hierarchical Bayesian model. They use this to find parameters that make up the dynamics and reward function of a problem. In Sunmola, instances of the  source tasks are used as a prior in order to find parameters.
